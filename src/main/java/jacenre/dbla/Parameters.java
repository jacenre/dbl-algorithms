 ...
 *
 * @see <a href="https://canvas.tue.nl/files/1978093/download?download_frd=1">
 *      Problem description 2.1 Input Format</a>
 */
public class Parameters {
	 ...
	 * <p>
	 * Describes the variant that needs to be solved. Where variant {@code \in
	 * {free, fixed}}
	 * </p>
	 *
	...
	/**
	 * Boolean representing if this Parameters object was parsed by the
	 * {@link FreeHeightUtil}.
	 * <p>
	 * The reason for this boolean is that when you use the compound solver in the
	 * {@code FreeHeightUtil} it will set the {@link #heightVariant} to
	 * {@code HeightSupport.FIXED} and since it only checks the HeightSupport at the
	 * beginning of the {@link FreeHeightUtil#pack(Parameters)} it will send the
	 * {@code Parameters} to all the children of a {@link CompoundSolver} without
	 * them being suited for free height solving.
	 * </p>
	 * <p>
	 * If this boolean is set to {@code True} it means that the
	 * {@code heightVariant} should be overruled to FIXED.
	 * </p>
	 */
	 ...
	 * <p>
	 * If the input has {@code heightVariant == Util.HeightSupport.FIXED} then this
	 * will represent the maximum height of the solution.
	 * </p>
	 */
	public int height = 0;
	...
	public Parameters(int height, Util.HeightSupport heightVariant, boolean rotation, List<Rectangle> rectangles) {
		this.height = height;
		this.heightVariant = heightVariant;
		this.rotationVariant = rotation;
	...
	/**
	 * Prints this {@code Solution} object as a string, containing debug
	 * information.
	 *
